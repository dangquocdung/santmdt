              ...
              <div class="advertisement-right">
                <div id="advertisement-right-carousel" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="item active">
                      <div class="text-center">
                        <img src="{{ asset('images/add-sample/girl.jpg') }}" alt="" class="img-responsive" />
                      </div>
                    </div>
                    <div class="item">
                      <div class="text-center">
                        <img src="{{ asset('images/add-sample/sunglass.png') }}" alt="" class="img-responsive" />
                      </div>
                    </div> 
                    <div class="item">
                      <div class="text-center">
                        <img src="{{ asset('images/add-sample/mobile.png') }}" alt="" class="img-responsive" />
                      </div>
                    </div>
                  </div>
                  <div class="slider-control-main text-center">
