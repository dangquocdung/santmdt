          ...
          <div class="advertisement-right">
            <div id="advertisement-right-carousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                ...
                <div class="item">
                  <div class="text-center">
                    <a href=""><img src="{{ asset('images/add-sample/sunglass.png') }}" alt="" class="img-responsive" /></a>
                  </div>
                </div> 
                <div class="item">
                  <div class="text-center">
                    <a href=""><img src="{{ asset('images/add-sample/mobile.png') }}" alt="" class="img-responsive" /></a>
                  </div>
                </div>
              </div>
              <div class="slider-control-main text-center">
