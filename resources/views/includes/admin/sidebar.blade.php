<aside class="main-sidebar">
  <section class="sidebar">
    <ul class="sidebar-menu"> 
      ...
      @if( (in_array('manage_pages_full', $user_permission_list)) || (in_array('manage_blog_manager_full', $user_permission_list)) || (in_array('manage_testimonial_full', $user_permission_list)) || (in_array('manage_brands_full', $user_permission_list)) || (in_array('manage_seo_full', $user_permission_list)))
      <li class="sidebar-cms-title">{!! trans('admin.sidebar_cms_title') !!}</li>  
      @endif
      
      @if(in_array('manage_pages_full', $user_permission_list))
      ...
      @if(in_array('manage_blog_manager_full', $user_permission_list))
      ...
      @if(in_array('manage_testimonial_full', $user_permission_list))
      ...
      @if(in_array('manage_brands_full', $user_permission_list))
      ...
      @if((in_array('manage_products_full', $user_permission_list)) || (in_array('manage_orders_list', $user_permission_list)) || (in_array('manage_reports_list', $user_permission_list)))
      <li class="sidebar-cms-title">{!! trans('admin.sidebar_sales_channel_title') !!}</li>
      @endif
        
      @if(in_array('manage_products_full', $user_permission_list))  
      ...
      @if(in_array('vendors_access_full', $user_permission_list) || in_array('vendors_packages_full_access', $user_permission_list))
      <li class="sidebar-vendor-title">{!! trans('admin.sidebar_vendor_title') !!}</li>
      @endif
      
      @if(in_array('vendors_access_full', $user_permission_list))
...
<!--            @if(in_array('vendors_refund_request_access', $user_permission_list)) 
      ...
      @if(in_array('vendors_packages_full_access', $user_permission_list)) 
...
<!--              @if(Request::is('admin/designer/fonts/list') || Request::is('admin/designer/font/add') || Request::is('admin/designer/font/update/*'))
      ...
      @if((in_array('manage_requested_product_menu_access', $user_permission_list)) || (in_array('manage_subscription_menu_access', $user_permission_list)) || (in_array('manage_extra_features_access', $user_permission_list)))
