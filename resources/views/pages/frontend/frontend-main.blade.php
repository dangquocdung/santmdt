...
@elseif(Request::is('stores'))
  @include('pages.frontend.vendors.vendors-list')
  @section('title', trans('frontend.vendor_list_title_label') .' < '. get_site_title())
  @yield('vendors-list-page-content')
  
@elseif(Request::is('store/details/home/*') || Request::is('store/details/products/*') || Request::is('store/details/reviews/*') || Request::is('store/details/cat/products/*'))
  @include('pages.frontend.vendors.vendor-details')
  @section('title', trans('frontend.vendor_details_title_label') .' < '. get_site_title())
  @yield('vendors-details-page-content')  
@endif
@endsection