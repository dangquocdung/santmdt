                  ...
                  <div class="uploaded-header-slider-images">
                    ...
                    <div class="uploaded-slider-images" style="display:block;">
                      @foreach(get_appearance_header_settings_data() as $slider_img)
                        <div class="header-slider-image-single-container {{ substr(basename($slider_img->img_url), 0, -4) }}"><img class="img-responsive" src="{{ substr($slider_img->img_url) }}"><div data-id="{{ $slider_img->id }}" class="remove-frontend-img-link" style="display: none;"></div></div>
                      @endforeach
                    </div>
                    @else
