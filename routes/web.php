...
Route::get( '/vendor/registration', [
  'uses' => 'Auth\RegisterController@redirectToVendorRegistrationProcess',
...
Route::post( '/vendor/registration', [
  'uses' => 'Auth\RegisterController@vendorRegistration',
...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin'], function () {
  ...
  Route::get('vendors/withdraw/request_delete/{id}', [
    'uses' => 'AdminDashboardController@deleteVendorWithdrawRequest',
  ...
  Route::get('order/invoice/{order_id}', [
    'uses' => 'AdminDashboardController@redirectOrderInvoice',
